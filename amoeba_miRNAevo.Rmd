...
```{r Plot of miRNA origins, fig.height=4, fig.width=8}
plotdat <-  comb_passed
...
```{r Plots of miRNA characteristics,  fig.width=8, fig.height=5}
...
```{r AT of miRNAs and intergenic regions, fig.width=6, fig.height=4}
...
```{r Output table with miRNA characteristics}
# miRPM <- data.frame()
# for (species in species_list) {
